//! Verifiable Encryption fixed bases.
use super::{L_VALUE, L_VERIFIABLE_ENCRYPTION_SCALAR};
use ff::PrimeField;
...
pub const NUM_WINDOWS: usize =
    (L_VERIFIABLE_ENCRYPTION_SCALAR + FIXED_BASE_WINDOW_SIZE - 1) / FIXED_BASE_WINDOW_SIZE;
...
pub struct VerifiableEncryptionFixedBases;
#[derive(Debug, Eq, PartialEq, Clone)]
...
impl FixedPoints<pallas::Affine> for VerifiableEncryptionFixedBases {
